...
export default function Comments({
  ...
  const handleCommentOnCommentAdded = (data: any) => {
  ...
  useEffect(() => {
    ...
    channel.bind("comment-added", handleCommentAdded);
    channel.bind("comment-on-comment-added", handleCommentOnCommentAdded);
    ...
    return () => {
      channel.unbind("comment-added", handleCommentAdded);
      channel.unbind("comment-on-comment-added", handleCommentOnCommentAdded);
