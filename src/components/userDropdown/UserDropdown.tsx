...
export default function UserDropdown() {
    ...
    return (
        <div style={{ left: `${state.dropdownPos.left}px`, top: `${state.dropdownPos.top}px`, position: "fixed" }} className="fixed z-50 flex gap-2 rounded shadow outline outline-1 dark:outline-zinc-800 flex-col p-2 bg-white dark:bg-zinc-900">
            <button onClick={() => {
            ...
            }} type="button" className="text-xs cursor-pointer">View profile</button>
        </div>
    )
}