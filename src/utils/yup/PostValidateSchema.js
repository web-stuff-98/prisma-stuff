...
export default Yup.object().shape({
    ...
    tags:  Yup.string().max(70, 'Tags too long. Maximum 80 characters')
    .test('missingHashtag', 'You need an # symbol for each tag.', (value) => (value && value.charAt(0) === '#'))
    .test('tooManyTags', 'Maximum 6 tags.', (value) => (value && value.split('#').filter((t) => t.trim() !== "").length < 7))
